...
namespace Loader
{
    public partial class Form2 : MetroForm
    {
        ...
        private void metroButton1_Click(object sender, EventArgs e)
        {
            ...
            string updater = "aHR0cHM6Ly9lZmZleC54eXovYXV0aC9jaGVjay5waHA=";

            byte[] data = Convert.FromBase64String(updater);
            string updatar = Encoding.UTF8.GetString(data);

            webBrowser1.Navigate(updatar +"?" + "username=" + metroTextBox1.Text + "&password=" + metroTextBox2.Text + "&hwid=" + hwid);
        }
        ...
        {
            System.Diagnostics.Process.Start("https://effex.xyz/forums/member.php?action=lostpw");
        }
        ...
        {
            System.Diagnostics.Process.Start("https://effex.xyz/forums/member.php?action=register");
            /*this.Hide();
            var form4 = new Form4();
